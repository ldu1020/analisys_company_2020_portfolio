...
const dataSet = [
  {
    ...
    basis: '영업이익 / 투하자본 ',
    description:
      '투하자본 수익률로써, 투하자본이 적고 영업이익이 높을수록 긍정적이며, 다년간의 자료를 분석해 보면 좋습니다. 투하자본의 산출근거는  (유형자산 + 매출채권 - 매입채무) 입니다.',
    plus: ['영업이익'],
  ...
  {
    title: '고정자산회전률',
    basis: '매출액 / 고정자산(비유동자산)',
    description:
      '고정자산에 투하된 자금은 장기간에 걸쳐 묶이기 때문에 효율적으로 운용되지않으면 현금흐름도 악화됩니다. 특히 그 비용이 높은 대기업에서 중요한 지표가 됩니다. 수치가 업계마다 상이해서 동종업계 평균치와 비교해보는것이 좋습니다. 조회 실패 시 "비유동자산" 을 검색 해 보세요!',
    plus: ['매출액'],
    division: ['고정자산'],
  },
  {
    ...
    basis: '인건비 / 부가가치',
    description:
      '노동분배율은 기업의 보상수준과 노동 효율성등을 나타내는 지표입니다.  낮을 수록 효율적임을 뜻하지만 분석의도에따라 긍정부정은 달라질 수 있습니다. 부가가치의 산출근거는 편의를 위해 (영업이익 + 인건비)로 측정했습니다. ',
    plus: ['인건비'],
    division: ['인건비', '영업이익'],
  },
];
